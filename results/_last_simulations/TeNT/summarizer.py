...
if __name__ == "__main__":
    base_directory = "/Users/nikollas/Library/CloudStorage/OneDrive-UniversityofSouthFlorida/MNTB_neuron/PN_MNTB_modeling/results/_last_simulations/TeNT"  # Change to your actual path
