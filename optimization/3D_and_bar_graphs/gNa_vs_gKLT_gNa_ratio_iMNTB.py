...
filename = "gNa_vs_gKLT_gNa_ratio_iMNTB_average"
...
plt.title('Spike Count vs gNa and gKLT/gNa Ratio - iMNTB')
plt.grid(False)
plt.tight_layout()
plt.show()
...
ax.set_title('3D Surface of Spike Count vs gNa and gKLT/gNa Ratio - iMNTB')
